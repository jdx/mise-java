...
--
CREATE INDEX IF NOT EXISTS JVM_IDX_ARCHITECTURE ON JVM (architecture);

CREATE INDEX IF NOT EXISTS JVM_IDX_OS ON JVM (os);

CREATE INDEX IF NOT EXISTS JVM_IDX_VENDOR ON JVM (vendor);

CREATE INDEX IF NOT EXISTS JVM_IDX_VERSION ON JVM ("version");
